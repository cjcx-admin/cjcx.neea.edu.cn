...
function createDebouncedFunction(func, wait) {
  ...
  debounceMap.set(func, wrappedFunction);
...
serv.getUserData = function (validateLogin, callback) {
  var url =
    serv.requestUrl + "/cxbb/user/info?t=" + Math.floor(new Date().getTime());
...
serv.loadCurrentUser = function (validateLogin, $xm, $sfz) {
  ...
  if ($.isEmptyObject(userBean)) {
    ...
    const __getJqueryObj = function ($obj) {
      if (!$obj) {
        return null;
      }
      const _$obj = $($obj);
    ...
    const __showUserInfo = function () {
      var xmObj = $xm ? __getJqueryObj($xm) : $("#xm"),
        sfzObj = $sfz ? __getJqueryObj($sfz) : $("#sfz");
      ...
      $("#welcome").append(
        '<a class="profile" href="https://iam.neea.edu.cn" target="_blank" style="margin-right: 4px;">个人中心</a>|'
      );
      $("#welcome").append(
        '<a href="javascript:serv.userLogout()" class="but" style="float:none; margin-left: 4px;" >退出</a>'
      );
      try {
...
function __goLogin() {
  ...
  if (code && state) {
    location.href =
      serv.requestUrl + "/auth/redirect?code=" + code + "&state=" + state;
    return;
  }
  var redirectUrl = location.href;
  var url =
    serv.requestUrl + "/auth/state?t=" + Math.floor(new Date().getTime());
  var params = {
  ...
  $ajax("post", url, params, false, function (result) {
    ...
    if (state) {
      var loginUrl =
        "https://iam.neea.edu.cn/login.html?client_id=prod_query_web&response_type=code&redirect_uri=" +
...
var goLogin = createDebouncedFunction(__goLogin, 1000);
...
serv.selectToZSBH = function (t) {
  var type = parseInt($("[name=type]").val()) || 1,
    field = "证书编号";
  ...
  $("input[name=zsbh]").attr({
    alt: field,
    placeholder: title + "上的" + (field.length > 7 ? "编号" : field),
  });
  $("#zsbh_err").text(
    $("#zsbh_err")
      .text()
      .replace(/成绩报告单编号|准考证号|证书编号|成绩报告单\/证书编号/, field)
  );
...
serv.verifys = function (t) {
  ...
  $(t)
    .hide()
    .attr("src", serv.requestUrl + "/verify/get?t=" + Math.random())
    .fadeIn();
};
...
serv.checkLatestStage = function () {
  ...
  if (!stage) {
    ...
    var $xm = $("#xm"),
      $sfz = $("#" + (serv.latestSubject == "CET" ? "no" : "sfz"));
    //加载用户及欢迎信息
    ...
    if (serv.latestSubject == "CET") {
      layer.msg(
        "当次成绩查询服务已下线，如有需要，请点击访问<a target='_blank' href='https://cet.neea.edu.cn/cet/' style='color:#01ADEF'>https://cet.neea.edu.cn/cet/</a>。"
      );
      return false;
    }
    //下线进历史
  ...
  if (name) {
    ...
    if (config["KMS"]) {
      ...
      $.each(config["KMS"], function (index, km) {
        $("#km").append(
          '<option value="' + km["key"] + '">' + km["text"] + "</option>"
        );
      });
    }
  }
...
serv.isSfz18 = function (value) {
  if (value && value.length === 18) {
    return /^([1-6][1-9]|50)\d{4}(18|19|20)\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/.test(
      value
    );
  }
  return false;
...
serv.isSfz15 = function (value) {
  if (value && value.length === 15) {
    return /^([1-6][1-9]|50)\d{4}\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}$/.test(
      value
    );
  }
  return false;
...
serv.queryCetResultList = function () {
  ...
  if (subject === "CET4") {
    result = {
      ...
      data: {
        xm: "姜仁舜",
        sfz: "210281200207316438",
        list: [
          {
            xm: "姜仁舜",
            sfz: "210281200207316438",
            xx: "渤海大学",
            zkzh: "212310241113029",
            score: "378",
            ky: "--",
            zsbh: "241121231002039",
            subject: "CET4",
            exam_id: "2RLIDkkfJ3zFHbet4jnsE7",
            exam: "2024年上半年",
            tab: "CET4_202406",
            token:
              "",
            tid: "2RLIDkkfJ3zFHbet4jnsE7|212310241113029",
            bkjb_code: "CET4",
            is_down: 1,
          },
          {
            ...
            sfz: "210281200207316438",
            xx: "渤海大学",
            zkzh: "212310231109318",
            score: "379",
            ky: "--",
            zsbh: "231121231002184",
            subject: "CET4",
            exam_id: "0Wu5GeXxN7AF3X9tm4Q90u",
            exam: "2023年上半年",
            tab: "CET4_202306",
            token:
              "",
            tid: "0Wu5GeXxN7AF3X9tm4Q90u|212310231109318",
            bkjb_code: "CET4",
            is_down: 1,
          },
          {
            ...
            sfz: "210281200207316438",
            xx: "渤海大学",
            zkzh: "212310222110404",
            score: "498",
            ky: "--",
            zsbh: "222121231002441",
            subject: "CET4",
            exam_id: "3uPsBV7eh9LVRPNoFhoeoC",
            exam: "2022年下半年",
            tab: "CET4_202212",
            token:
              "",
            tid: "3uPsBV7eh9LVRPNoFhoeoC|212310222110404",
            bkjb_code: "CET4",
            is_down: 1,
          },
          {
            ...
            sfz: "210281200207316438",
            xx: "渤海大学",
            zkzh: "212310212113813",
            score: "374",
            ky: "--",
            zsbh: "212121231002752",
            subject: "CET4",
            exam_id: "22Gj2IXFh8eFDZ8vu9K3j1",
            exam: "2021年下半年",
            tab: "CET4_202112",
            token:
              "",
            tid: "22Gj2IXFh8eFDZ8vu9K3j1|212310212113813",
            bkjb_code: "CET4",
            is_down: 1,
          },
          {
            ...
            sfz: "210281200207316438",
            xx: "渤海大学",
            zkzh: "212310211113911",
            score: "279",
            ky: "--",
            zsbh: "211121231002394",
            subject: "CET4",
            exam_id: "1QeCbKV3t2tHCzKNb2tg70",
            exam: "2021年上半年",
            tab: "CET4_202106",
            token:
              "",
            tid: "1QeCbKV3t2tHCzKNb2tg70|212310211113911",
            bkjb_code: "CET4",
            is_down: 1,
          },
        ],
...
serv.queryPETSResultList = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    achievementTbody.html("");
    var _tr = $(
      '<tr style="background:rgb(13, 163, 226);color:#FFFFFF;"></tr>'
    );
    var _th, _td;
    $.each(showFields, function (code, name) {
      _th = $(
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        ...
        if (code == "sf") {
          ...
          fieldVal = bean.bkjb_name || dict.getLevelName(bean);
        } else {
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        if (code == "exam") {
          ...
          var fieldVal = bean.bkjb_name || dict.getLevelName(bean);
          _lititle = $(
            "<span style='margin-bottom: 2px;'>" + fieldVal + "</span>"
          );
          _hi.before(_lititle);
        } else {
          var fieldVal = bean[code] ? bean[code] : "--";
...
var subj = {
  PETS: {
    name: "全国英语等级考试(PETS)",
    tab: [null, "", "PETS_202103"],
  },
  WSK: {
    name: "全国外语水平考试(WSK)",
    tab: [null, "WSK_1911", "WSK_202105"],
  },
  CET4: {
    name: "全国大学英语四级考试(CET4)",
    tab: [null, "CET4_202106"],
    type: "成绩报告单",
  },
  CET6: {
    name: "全国大学英语六级考试(CET6)",
    tab: [null, "CET6_202106"],
    type: "成绩报告单",
  },
  CJT4: {
    name: "全国大学日语四级考试(CJT4)",
    tab: [null, "CJT4_202106"],
  },
  CJT6: {
    name: "全国大学日语六级考试(CJT6)",
    tab: [null, "CJT6_202106"],
  },
  CRT4: {
    name: "全国大学俄语四级考试(CRT4)",
    tab: [null, "CRT4_202106"],
  },
  CRT6: {
    name: "全国大学俄语六级考试(CRT6)",
    tab: [null, "CRT6_202106"],
  },
  PHS4: {
    name: "全国大学德语四级考试(PHD4)",
    tab: [null, "PHS4_202106"],
  },
  PHS6: {
    name: "全国大学德语六级考试(PHD6)",
    tab: [null, "PHS6_202106"],
  },
  TFU4: {
    name: "全国大学法语四级考试(TFU4)",
    tab: [null, "TFU4_202106"],
  },
  "CET-SET": {
    name: "全国大学英语四、六级口语考试(CET-SET)",
    type: "成绩报告单",
  },
  CBT: {
    name: "全国大学英语四、六级考试(网考)",
    type: "成绩报告单",
  },
  NCRE: {
    name: "全国计算机等级考试(NCRE)",
    tab: [null, "~", "NCRE_202203"],
  },
  "NCRE-ZY": {
    name: "全国计算机等级考试(NCRE)",
    tab: [null, "~", "NCRE_202203"],
  ...
  NIT_ADVANCED: {
    name: "全国计算机应用水平考试(NIT)",
    tab: [null, "~", "NIT_202304_ADVANCE"],
  },
  CCPT: {
    name: "书画等级考试(CCPT)",
    tab: [null, "~", "CCPT_202305"],
    type: "证书",
  },
};
if (!window.console) {
...
var CHAR_WIDTH = [
  295, 312, 435, 638, 586, 889, 870, 256, 333, 333, 455, 741, 240, 432, 240,
  427, 586, 586, 586, 586, 586, 586, 586, 586, 586, 586, 240, 240, 741, 741,
  741, 482, 1031, 703, 627, 668, 761, 549, 531, 743, 773, 293, 395, 634, 513,
  977, 812, 814, 611, 814, 652, 577, 573, 746, 676, 1017, 645, 603, 620, 333,
  416, 333, 741, 448, 294, 552, 638, 501, 639, 567, 346, 639, 615, 266, 267,
  544, 266, 937, 616, 635, 638, 639, 381, 462, 372, 616, 524, 789, 506, 529,
  491, 333, 269, 333, 741, 295,
];
...
serv.pdfData = function (par) {
  ...
  let ret = null;
  if (par.subject === "CET4") {
    if (par.tab === "CET4_202406") {
      ret = {
        data: {
          XX: "渤海大学",
          SCO_LC: "121",
          KY_SCO: "--",
          _QR: "https://ecert.neea.edu.cn/verify.htm?Mo7irj64ypS0FO7mw4VovVG2t5L00_W1AkR25f3zvzj1cueL5gI6Gb5HgiDG2hrqKaTLZxjFTLoZ_vR3lTFhR2ucmapOsTAfTdvcab12PJNvv2xHr3Tep3C92_KmQnCzSiFZAhzu4nev5TyaHtrQlhdgp1-02Pnt213isckZTa9vuNA5LFt7viZCpwnOrPdAPjajPlsCv6lDlB04Oa_pf9xDbnH_oyusP8kLldE14zYHj9DdkbruwOh5Y8xVPWptPdt6oa7UbOjgk5HSYh9JIxPXO17tvqXrfkP_qcBsw5k=",
          SCORE: "378",
          SCO_RD: "128",
          SFZ: "210281200207316438",
          SCO_WT: "129",
          ...
          ZSBH: "241121231002039",
          KY_ZKZ: "--",
          _CODE: "EC9P 6OEX WRMD CHQY",
          _PHOTO:
            "d2544d78fdfc260d9709a75222681f0128532305d74813666f9dd9ceb95087634fc7da163b3ca0b02950986a5e36164aa87a59c017084ba716bb5c77f25a8158",
          _BKJB: "RESULT",
          YX: "数学科学学院",
        },
        group: [
          {
            QUERY_DEF_ID: "1kq3twtKt2bqxnCWQ2OnCS1n",
            BG: "images/CET_result_CET4_202306.jpg",
            BGW: 397,
            BGH: 575,
            NAME: "XM",
            FIELD_TYPE: 1,
    ...
    } else if (par.tab === "CET4_202306") {
      ret = {
        data: {
          XX: "渤海大学",
          SCO_LC: "126",
          KY_SCO: "--",
          _QR: "https://ecert.neea.edu.cn/verify.htm?Mo7irj64ypS0FO7mw4VovVbvcjrTIH94mmbj9C6iaZi-ZYbQybuOE5Y3KwO8BYULSa5QcOevFZr35l_BufGmDm4KT-OreDpl36XGAyUBES5lcVA_XvC8ftkcgyi7viD6LprYTW7a_DKIZQ7NDyCwIG04DYmGiWbaFUWaH8nc3VynDM1aq_MCT9E-Qid5H_q_Ti-CUpsPpoSQvV7KuwDVn6wLhw7maehI3c3AAV5ZplNvFoc-A--1PdldAjJpHuZrz5l06V8dyXR96cwFEwz-qLILqqVLHNWGI3qTuB5pgzc=",
          SCORE: "379",
          SCO_RD: "140",
          SFZ: "210281200207316438",
          SCO_WT: "113",
          ...
          ZSBH: "231121231002184",
          KY_ZKZ: "--",
          _CODE: "9HG1 2CW2 BM55 9V6D",
          _PHOTO:
            "99b0f34d52cc4d86979223b16afb2f9a6a67d36441a41695ad341d7618e69e9162fef5b659ec4f66ebb510b0df695c289a77d4964486ec09dbbc308b5979a058",
          _BKJB: "RESULT",
          YX: "数学科学学院",
        },
        group: [
    ...
    } else if (par.tab === "CET4_202212") {
      ret = {
        data: {
          XX: "渤海大学",
          SCO_LC: "151",
          KY_SCO: "--",
          _QR: "https://ecert.neea.edu.cn/verify.htm?Mo7irj64ypS0FO7mw4VovSXrh808GeD8MKAOfP0jgK697nfMktnj_OiDHWzNyLncJGGqF6Ye9qTLv52DN4XYYQdsTpNM9S84end6ukmNfulOrdMxOk3S0e2vbq1Qhjt9CiAS2z-Uzlo2kD0dZD8TNKgcwBiWjXB_FvrjOq-3uvEcx06_8OFbG09hJL4GORW9Tpeugt16CHXjyOWNufyYQPAJs6fb6pT3JdGN7nesb3jSC3mluSm7Q8TX4NrnsP5hymet5a-vWAUWUN7J5xEP3gy-b4QcA43lTLnOT2O0hpM=",
          SCORE: "498",
          SCO_RD: "185",
          SFZ: "210281200207316438",
          SCO_WT: "162",
          ...
          ZSBH: "222121231002441",
          KY_ZKZ: "--",
          _CODE: "V9LB EH18 ZOET 0MJY",
          _PHOTO:
            "61f23e2a09ff05839480e718d3c4254da9de81fb9f4fb5286efe744cc422ecff0b676453b57ded0291ee1fe289918be7dbec5225955ff3fae93d99ee5fb12e7f",
          _BKJB: "RESULT",
          YX: "数学科学学院",
        },
        group: [
    ...
    } else if (par.tab === "CET4_202112") {
      ret = {
        data: {
          XX: "渤海大学",
          SCO_LC: "108",
          KY_SCO: "--",
          _QR: "https://ecert.neea.edu.cn/verify.htm?Mo7irj64ypS0FO7mw4VoveGgIiXV06ySV_3kq0mFnrKo1axVTMWdziDyi4dhrJtTJ0bOXtC44FE1bfJtMKR0SZsE4rP5f2oNwGmA8VRR8Adj0fGQefi10_Q1v08GXr6c4BZ1jh5D_gofBhjzVR7cn9ULMkN157nOre8IjHr6WRgFHRM9Ey1DDWfOuJjuu0yeJ249C6cLvNRuSyJtHvcVJoKXaurcra_AgNHPJxYBEUDck_rDtBhTfwWUqvy33cxYX0XemFJdeG-yBQte-oL4g_-VJaliaL443KrAVTHVYpk=",
          SCORE: "374",
          SCO_RD: "164",
          SFZ: "210281200207316438",
          SCO_WT: "102",
          ...
          ZSBH: "212121231002752",
          KY_ZKZ: "--",
          _CODE: "DTMB XNWS NQGD Z71H",
          _PHOTO:
            "65527c6f6909dab8936828186fad810b669914c8c843a31bca26b3def23410e2c911ebe978e27c6b90485923a0280c95101d12122e23b6573c62ab650623d5ba",
          _BKJB: "RESULT",
          YX: "数学科学学院",
        },
        group: [
          {
            QUERY_DEF_ID: "0jcf2WiUh9MrC0e3Gj0XlE",
            BG: "images/CET_result_CET4_202106.jpg",
            BGW: 397,
            BGH: 575,
            NAME: "XM",
            FIELD_TYPE: 1,
    ...
    } else if (par.tab === "CET4_202106") {
      ret = {
        data: {
          XX: "渤海大学",
          SCO_LC: "95",
          KY_SCO: "--",
          _QR: "https://ecert.neea.edu.cn/verify.htm?Mo7irj64ypS0FO7mw4VovYf1izr64SwPhbmfuLqCk3d7Ed3hs8oC2N4PqZig2poEnV3AZkL_xdAtAaUOGK_dSPHT9Qxsd-0X4RgUR8M503D_SnrCxY0dshchMKGkDnlrNPRHSCkLXLjN7UoTgz86qAFb4irY6bwxZ_3iFvxcf3RBeh1baKXHKrG5DuBFCF0eHhkL6hqEmdu3FqzoaN9ajFFkNQKALS9TbyyEwDUPujT_J9a8E3RMzEg4X_DLWzi8mw4tprPsNuFh5YZ6wC1SNOdVG3mCo3e2ZMly6BNiWtY=",
          SCORE: "279",
          SCO_RD: "114",
          SFZ: "210281200207316438",
          SCO_WT: "70",
          ...
          ZSBH: "211121231002394",
          KY_ZKZ: "--",
          _CODE: "CSRL E4FH R2TK YTY0",
          _PHOTO:
            "11758e25727d3fe54f114af557439c9ca59d9ddf0fb19fd8fd069a792fdd1b6fe769dd5dee992633afec893dcb6f9e7732f9ab03f3c5dda93d645ff81b78fb32",
          _BKJB: "RESULT",
          YX: "数学科学学院",
        },
        group: [
...
serv.pdfQuick = function (frm) {
  ...
  $ajax(
    "post",
    "//appquery.neea.edu.cn/api/pdf/quick",
    par,
    true,
    function (ret) {
      layer.close(loadIndex);
...
serv.pdf = function (par, ret) {
  ...
  if (!vid && serv.isDown(par)) {
    ...
    if (tname) {
      ...
      $("a.btn").html(
        $("a.btn")
          .html()
          .replace(/成绩单|证书/, tname == "合格证书" ? "证书" : "成绩单")
      );
    }
  } else {
    $(".cdown").hide();
  ...
  try {
    ...
    for (var i = 0; i < li.length; i++) {
      ...
      if (d.NAME == "_PHOTO") {
        ...
        if (d.NAME == "BEIZHU") {
          ...
          if ([210330653, 210330658].indexOf(node.id) == -1)
            resize += v.length * 60; //加粗
        ...
        if (!dev.mobile && s < 12 && layui.device("chrome").chrome) {
          ...
          var SCALE = [
            0, 0.07, 0.17, 0.25, 0.333, 0.417, 0.5, 0.583, 0.667, 0.75, 0.834,
            0.917,
          ]; //Safari可以缩小字号
          //s = SCALE[parseInt(s)];
    ...
    $(".cbody")
      .html(htm.join(""))
      .css({
        width: d0.BGW * scale + "px",
        height: d0.BGH * scale + "px",
      });
    $(".cbody")
      .off()
      .bind("selectstart contextmenu dragstart", function () {
        return false;
      });
    //浏览器缩放:二维码
    window.onresize();
...
window.onresize = function () {
  ...
  qr.off().hover(
    function () {
      if (tips) return;
      tips = layer.tips(
        qr.html().replace(/zoom:|transform:/, ""),
        this, //不去缩放：会有白边
        {
          tips: [4, "#fff"],
          time: 0, //, area:qr.find("tr").length*2+30+'px' //area:不写会变形
        }
      );
...
serv.pdfOther = function () {
  ...
  $ajax("post", url, par, true, function (ret) {
    ...
    $(".ctype").text(
      subj[par.subject].type || (par.type == 1 ? "成绩通知单" : "合格证书")
    );
...
serv.queryNtceResult = function (isCorp) {
  ...
  if (!isCorp && isLatest) {
    ...
    masterUrl = serv.latestMasterUrl + "/latest/results/ntce";
    slaveUrl = serv.latestSlaveUrl
      ? serv.latestSlaveUrl + "/latest/results/ntce"
      : null;
    ...
    masterUrl =
      serv.requestUrl +
      (isCorp ? "/cxbb/results/list/corp" : "/cxbb/results/list");
  }
  //获取参数
  var subject = $("#subject").val();
  var xm = $("#xm").val();
...
serv.queryCorpNtceResult = function () {
  ...
  var url = serv.requestUrl + "/cxbb/results/list/corp";
...
serv.handleNtceResultPc = function (result) {
  try {
    ...
    if (result.data.ms) {
      ...
      var _tr = $(
        '<tr style="background: #c0a274 !important;color:#FFFFFF;"></tr>'
      );
      var _th, _td;
        ...
        $.each(showFields_bs, function (code, name) {
          if (code == "km") {
            ...
            if (bean[code] == "合格") {
              ...
              _li = $(
                "<span class='rank unqualified'>" + bean[code] + "</span>"
              );
...
serv.queryLastestCetResult = function () {
  if (
    !serv.checkCondion($("#km")) ||
    !serv.checkCondion($("#xm")) ||
    !serv.checkCondion($("#no"))
  ) {
    return false;
  }
  var config = serv.latestConfig;
  ...
  var masterUrl = serv.latestMasterUrl + "/latest/results/cet";
  var slaveUrl = serv.latestSlaveUrl
    ? serv.latestSlaveUrl + "/latest/results/cet"
    : null;
  //获取参数
  var km = $("#km").val();
  var xm = $("#xm").val();
...
serv.queryPETSCERTList = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        var _tda = $(
          "<a href=" + down + " style=margin-left:10px;>下载合格证书</a>"
        );
        _tda.mouseup(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
...
serv.queryPETSCERTListMobile = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        _tda = $(
          "<a href=" + down + " class='button-main-tinner'>下载合格证书</a>"
        );
        _tda.click(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        if (code == "exam") {
          ...
          _lititle = $(
            "<span style='margin-bottom: 2px;'>" + bean[code] + "</span>"
          );
          _hi.before(_lititle);
        } else if (code == "hg") {
          if (bean[code] == "合格") {
...
serv.queryNTCECERTList = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        var _tda = $(
          "<a href=" + down + " style=margin-left:10px;>下载合格证明</a>"
        );
        _tda.mouseup(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
...
serv.queryNTCECERTListMobile = function () {
  ...
  var isVerify =
    !serv.checkCondion($("#xm")) || !serv.checkCondion($("#sfz"), true);
  ...
  if (dcResultsObj) {
    if (ptype == "ntcecachecloud") {
      url = "//cachecloud.neea.cn/latest/results/ntce";
      subject = "NTCE_BS";
      params = {
        subject: subject,
        xm: xm,
      ...
      url = "//cache.neea.edu.cn/latest/results/ntce";
...
serv.queryCorpNtceCertList = function () {
  ...
  var url = serv.requestUrl + "/cxbb/cert/list/corp";
  var loadIndex = layer.load(0, {
    shade: 0.1,
  });
  $ajax("post", url, params, true, function (result) {
...
serv.queryNTCECERT = function (subject, tab, exam, token, exam_id) {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    if (dataBean.poken) {
      photoObj.attr(
        "src",
        "https://appquery.neea.edu.cn/cxbb/cert/photo?poken=" + dataBean.poken
      );
    } else {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        var fieldVal;
        if (code == "bkjb") {
          fieldVal = bean.bkjb_name || dict.getLevelName(bean); //serv.bkjb(subjectName,bean[code],"");
        } else if (code == "cjdd") {
          fieldVal = bean.cjdd_name || dict.getScoreName(bean); //serv.cjdd(subjectName, bean[code], "");
        } else {
          fieldVal = bean[code] ? bean[code] : "--";
        }
...
serv.queryNCREResult = function (
  ...
  var src =
    "//search.neea.edu.cn/QueryDataAction.do?act=doPostCont&pram=results&reportPram=1&selectsub=" +
    selectsub +
    "&selectyear=" +
    selectyear +
    "&selectprovince=" +
    ...
    "&zkzh=" +
    zkzh +
    "&nexturl=//cjcx.neea.edu.cn/res/Home/structure/17099828.png";
...
serv.queryNCRECertList = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        var _tda = $(
          "<a href=" + down + " style=margin-left:10px;>下载证书</a>"
        );
        _tda.mouseup(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
...
function getUrlParamJson() {
  ...
  for (var i = 0; i < paramArr.length; i++) {
    ...
    var paramVal = decodeURIComponent(
      paramStr.substring(paramStr.indexOf("=") + 1, paramStr.length)
    );
...
serv.queryCcptCertListMobile = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        var _tda = $(
          "<a href=" + down + " class='button-main-tinner'>下载证书</a>"
        );
        _tda.mouseup(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
...
serv.queryNITERTList = function () {
  if (
    !serv.checkCondion($("#subject")) ||
    !serv.checkCondion($("#xm")) ||
    !serv.checkCondion($("#sfz"), true)
  ) {
    return false;
  }
  if (!serv.checkNonSfz()) {
    ...
    if (data.list.length > 1) {
      ...
      $.each(data.list, function (index, bean) {
        ...
        hre =
          ...
          "&pdfName=NTCE";
        var href =
          "http://search.neea.edu.cn/QueryDataAction.do?act=downQueryPdf&pram=certi" +
          hre;
        var _tdad = $(
...
serv.queryNTCEDCCERTListMobile = function () {
  ...
  $ajax("post", url, params, true, function (result) {
    ...
    if (data.list.length > 1) {
      ...
      $(".ntcetxtUl").eq(0).children(".ntcetoggle").show();
      $(".ntcetxtUl").eq(0).children(".km").children("i").css({
        transform: "rotate(135deg)",
      });
      $(".ntcetxtUl").eq(0).children(".km").children("i").text(2);
      $(".km").on("click", function () {
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        ...
        if (code == "bkjb") {
          ...
          cjddStr = fieldVal = bean.cjdd_name || dict.getScoreName(bean); //serv.cjdd(subjectName, bean[code], "");
        } else {
          fieldVal = bean[code] ? bean[code] : "--";
        }
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        if (code == "exam") {
          ...
          var fieldVal1 = (cjddStr = bean.cjdd_name || dict.getScoreName(bean)); //serv.cjdd(subjectName, bean[code], "");
          if (fieldVal1 == "及格") {
...
serv.queryNTCECERTListMobileHistory = function (isCorp) {
  ...
  var url =
    serv.requestUrl + (isCorp ? "/cxbb/cert/list/corp" : "/cxbb/cert/list");
  var loadIndex = layer.load(0, {
    shade: 0.1,
  });
  $ajax("post", url, params, true, function (result) {
    ...
    $.each(data.list, function (index, bean) {
      ...
      if (down) {
        _tda = $(
          "<a href=" + down + " class='button-main-tinner'>下载合格证明</a>"
        );
        _tda.click(function () {
          _hmt.push(["_trackEvent", "ecert", "down", subject + "-d", 1]);
        });
    ...
    $.each(data.list, function (index, bean) {
      ...
      $.each(showFields, function (code, name) {
        if (code == "exam") {
          ...
          var fieldVal1 = bean.cjdd_name || dict.getScoreName(bean);
          if (fieldVal1 == "合格") {
            _zh = $("<span class='rank qualified'>" + fieldVal1 + "</span>");
...
serv.rare = function () {
  ...
  $("#keyboard").html(
    "<img src=/tea/layui/css/modules/layer/default/loading-0.gif>"
  );
  $.get(
    "/query/js/rare_words.json",
    function (ret) {
      var arr = ret.Rare_words,
        htm = [];
      for (var i = 0; i < arr.length; i++)
      ...
      $("#keyboard li").click(function () {
        ...
        var fxm = form1.xm;
        try {
          if (document.selection) fxm.value = fxm.value + str;
          else {
            var s = fxm.selectionStart;
            fxm.value =
              fxm.value.substring(0, s) +
              str +
              fxm.value.substring(fxm.selectionEnd);
...
if (vid) {
  ...
  $.getScript("//www.neea.edu.cn/tea/base64.js", function () {
    $(function () {
      ...
      vid = vid.split("&");
      serv.pdfData({
        type: node.father == 200511151 ? 1 : 2,
        subject: vid[0],
        tab: vid[1] /*小语种*/,
        token: vid[3] || vid[1],
      });

      $(".outlogin,.imgpag,.cjdBtn").hide(); //下载,用户,导航,返回
    });
  });
}
