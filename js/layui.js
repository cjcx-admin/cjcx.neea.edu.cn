        ...
        e = {
            ...
            on: function(i, o, t) {
                ...
                if (n[0]) return n.data(a) || n.data(a, {
                    events: {},
                    callbacks: {}
                }), e = (a = n.data(a)).callbacks, o = s.extend(!0, a.events, o) || {}, n.off(t.trigger, r, e[i]), n.on(t.trigger, r, e[i] = function(t) {
                    var e = s(this),
                        n = e.attr(i);
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(n) {
    ...
    var f = layui.$,
        ...
        s = (i.prototype.config = {
            ...
            a.index = t.index, t.key = a.id || a.index, t.setInit(), a.height && /^full-.+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = d.height() - (parseFloat(t.fullHeightGap) || 0)) : a.height && /^#\w+\S*-.+$/.test(a.height) && (i = a.height.split("-"), t.parentHeightGap = i.pop(), t.parentDiv = i.join("-"), a.height = f(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0));
            var l, e = a.elem,
                i = e.next("." + D),
                n = t.elem = f("<div></div>");
            ...
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(R), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(y), t.layPage.find(O).addClass(y), k.cache[t.key] = [], t.syncCheckAll(), t.renderForm(), t.setColsWidth()
            ...
            return k.cache[a.key] = d, a.layTotal[0 == d.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](R), a.layPage.find(O)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](y), 0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(R), o ? u() : (u(), a.renderTotal(d, t), a.layTotal && a.layTotal.removeClass(R), void(i.page && (i.page = f.extend({
            ...
            var s = this,
                ...
                l = function(e, t) {
                    var a = f(this),
                        ...
                        r = f('<i class="layui-icon layui-icon-up ' + d + '">');
                    "tips" === (t = t || n.expandedMode || u.cellExpandedMode) ? s.tipsIndex = p.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (i.height() + 23) + "px;" + ("sm" === u.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === u.size ? "padding: 14px 15px;" : "") + '">', i.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), i[0], {
                        tips: [3, ""],
                        time: -1,
                        anim: -1,
